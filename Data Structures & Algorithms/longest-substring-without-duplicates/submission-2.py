class Solution:
    def lengthOfLongestSubstring(self, s: str) -> int:
        ...
        # then l is reset to r and the window begins expanding again(so does hashmap/set), checking 
        ...
        while r < len(s):
            # if s[r] not in hashmap, add to hashmap
            # else, compute longest, reset l, continue
            # r += 1
